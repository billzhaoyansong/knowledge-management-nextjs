...
export interface ApiPaperPaper extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    analysisFile: Schema.Attribute.Media<'files'>;
    authors: Schema.Attribute.JSON & Schema.Attribute.Required;
    bibtex: Schema.Attribute.Text;
    ...
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    summaries: Schema.Attribute.JSON;
    systemModel: Schema.Attribute.JSON;
    techniques: Schema.Attribute.JSON;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    type: Schema.Attribute.Enumeration<
      ['technical', 'survey', 'position', 'short']
    > &
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    images: Schema.Attribute.Media<'images', true>;
    isContainer: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::section.section'
