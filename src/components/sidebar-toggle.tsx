    ...
    <>
      ...
      {!open && (
        <button 
          ...
          className="fixed top-4 left-4 z-50 p-2 bg-black text-white rounded-md hover:bg-gray-800"
      ...
      {/* Sidebar */}
      <div className={`${open ? '' : 'hidden'} w-60 h-full bg-black text-white flex flex-col justify-between`}>
        ...
        <div className="rounded-r transform translate-x-0 ease-in-out transition duration-500 flex justify-start items-start h-full w-full flex-col">
          <div className="flex justify-between items-center p-6 w-full">
            <div className="flex items-center space-x-3">
              ...
              <p className="text-xl leading-6 text-white">Knowledge Management</p>
            </div>
            <button 
        ...
        <div className="flex flex-col justify-between items-center pb-6 px-6 w-full space-y-32">
          <div className="flex justify-between items-center w-full">
            <div className="flex justify-center items-center space-x-2">
              <div>
                <div className="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center">
                  <span className="text-sm font-medium text-gray-600">ZY</span>
                </div>
              </div>
              <div className="flex justify-start flex-col items-start">
                <p className="cursor-pointer text-sm leading-5 text-white">Zhao Yansong</p>
                <p className="cursor-pointer text-xs leading-3 text-gray-500">bill.zhaoyansong@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
