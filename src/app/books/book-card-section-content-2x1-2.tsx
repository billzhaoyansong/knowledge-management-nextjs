...
export default function BookCardSectionContent2x1_2({
    subsections
}: {
    subsections: SubSection[]
}) {

    const _1stSubSection = subsections.find(ss => ss.subSectionTitle.startsWith('1.1-1.2'))
    const _2ndSubSection = subsections.find(ss => ss.subSectionTitle.startsWith('2.1'))
