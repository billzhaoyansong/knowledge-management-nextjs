...
export default function BookCardSectionContent1x2_1({
    subsections
}: {
    ...
    const _2ndSubSection = subsections.find(ss => ss.subSectionTitle.startsWith('1.2-2.2'))
    const _3rdSubSection = subsections.find(ss => ss.subSectionTitle.startsWith('2.1'))
